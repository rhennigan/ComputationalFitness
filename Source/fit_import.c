...
static void import_session(WolframLibraryData libData, MTensor data, int idx, const FIT_SESSION_MESG *mesg)
{
    ...
    ImportInteger(39, libData, data, pos, mesg->enhanced_avg_speed);
    ImportInteger(40, libData, data, pos, mesg->enhanced_max_speed);
    ImportInteger(41, libData, data, pos, mesg->enhanced_avg_altitude);
    ImportInteger(42, libData, data, pos, mesg->enhanced_min_altitude);
    ImportInteger(43, libData, data, pos, mesg->enhanced_max_altitude);
    ImportInteger(44, libData, data, pos, mesg->training_load_peak);
    ImportFloat(45, libData, data, pos, mesg->total_grit);
    ImportFloat(46, libData, data, pos, mesg->total_flow);
    ImportFloat(47, libData, data, pos, mesg->avg_grit);
    ImportFloat(48, libData, data, pos, mesg->avg_flow);
    ...
    ImportInteger(58, libData, data, pos, mesg->first_lap_index);
    ImportInteger(59, libData, data, pos, mesg->num_laps);
    ImportInteger(60, libData, data, pos, mesg->num_lengths);
    ImportInteger(61, libData, data, pos, mesg->normalized_power);
    ImportInteger(62, libData, data, pos, mesg->training_stress_score);
    ImportInteger(63, libData, data, pos, mesg->intensity_factor);
    ImportInteger(64, libData, data, pos, mesg->left_right_balance);
    ImportInteger(65, libData, data, pos, mesg->avg_stroke_distance);
    ImportInteger(66, libData, data, pos, mesg->pool_length);
    ImportInteger(67, libData, data, pos, mesg->threshold_power);
    ImportInteger(68, libData, data, pos, mesg->num_active_lengths);
    ImportInteger(69, libData, data, pos, mesg->avg_altitude);
    ImportInteger(70, libData, data, pos, mesg->max_altitude);
    ImportInteger(71, libData, data, pos, mesg->avg_grade);
    ImportInteger(72, libData, data, pos, mesg->avg_pos_grade);
    ImportInteger(73, libData, data, pos, mesg->avg_neg_grade);
    ImportInteger(74, libData, data, pos, mesg->max_pos_grade);
    ImportInteger(75, libData, data, pos, mesg->max_neg_grade);
    ImportInteger(76, libData, data, pos, mesg->avg_pos_vertical_speed);
    ImportInteger(77, libData, data, pos, mesg->avg_neg_vertical_speed);
    ImportInteger(78, libData, data, pos, mesg->max_pos_vertical_speed);
    ImportInteger(79, libData, data, pos, mesg->max_neg_vertical_speed);
    ImportInteger(80, libData, data, pos, mesg->best_lap_index);
    ImportInteger(81, libData, data, pos, mesg->min_altitude);
    ImportInteger(82, libData, data, pos, mesg->player_score);
    ImportInteger(83, libData, data, pos, mesg->opponent_score);
    ImportIntegerSequence(84, libData, data, pos, mesg->stroke_count, FIT_SESSION_MESG_STROKE_COUNT_COUNT);
    ImportIntegerSequence(85, libData, data, pos, mesg->zone_count, FIT_SESSION_MESG_ZONE_COUNT_COUNT);
    ImportInteger(86, libData, data, pos, mesg->max_ball_speed);
    ImportInteger(87, libData, data, pos, mesg->avg_ball_speed);
    ImportInteger(88, libData, data, pos, mesg->avg_vertical_oscillation);
    ImportInteger(89, libData, data, pos, mesg->avg_stance_time_percent);
    ImportInteger(90, libData, data, pos, mesg->avg_stance_time);
    ImportIntegerSequence(91, libData, data, pos, mesg->avg_total_hemoglobin_conc, FIT_SESSION_MESG_AVG_TOTAL_HEMOGLOBIN_CONC_COUNT);
    ImportIntegerSequence(92, libData, data, pos, mesg->min_total_hemoglobin_conc, FIT_SESSION_MESG_MIN_TOTAL_HEMOGLOBIN_CONC_COUNT);
    ImportIntegerSequence(93, libData, data, pos, mesg->max_total_hemoglobin_conc, FIT_SESSION_MESG_MAX_TOTAL_HEMOGLOBIN_CONC_COUNT);
    ImportIntegerSequence(94, libData, data, pos, mesg->avg_saturated_hemoglobin_percent, FIT_SESSION_MESG_AVG_SATURATED_HEMOGLOBIN_PERCENT_COUNT);
    ImportIntegerSequence(95, libData, data, pos, mesg->min_saturated_hemoglobin_percent, FIT_SESSION_MESG_MIN_SATURATED_HEMOGLOBIN_PERCENT_COUNT);
    ImportIntegerSequence(96, libData, data, pos, mesg->max_saturated_hemoglobin_percent, FIT_SESSION_MESG_MAX_SATURATED_HEMOGLOBIN_PERCENT_COUNT);
    ImportInteger(97, libData, data, pos, mesg->stand_count);
    ImportIntegerSequence(98, libData, data, pos, mesg->avg_power_position, FIT_SESSION_MESG_AVG_POWER_POSITION_COUNT);
    ImportIntegerSequence(99, libData, data, pos, mesg->max_power_position, FIT_SESSION_MESG_MAX_POWER_POSITION_COUNT);
    ImportInteger(100, libData, data, pos, mesg->avg_lev_motor_power);
    ImportInteger(101, libData, data, pos, mesg->max_lev_motor_power);
    ImportInteger(102, libData, data, pos, mesg->avg_vertical_ratio);
    ImportInteger(103, libData, data, pos, mesg->avg_stance_time_balance);
    ImportInteger(104, libData, data, pos, mesg->avg_step_length);
    ImportInteger(105, libData, data, pos, mesg->avg_vam);
    ImportInteger(106, libData, data, pos, mesg->jump_count);
    ImportInteger(107, libData, data, pos, mesg->avg_core_temperature);
    ImportInteger(108, libData, data, pos, mesg->min_core_temperature);
    ImportInteger(109, libData, data, pos, mesg->max_core_temperature);
    ImportInteger(110, libData, data, pos, mesg->event);
    ImportInteger(111, libData, data, pos, mesg->event_type);
    ImportInteger(112, libData, data, pos, mesg->sport);
    ImportInteger(113, libData, data, pos, mesg->sub_sport);
    ImportInteger(114, libData, data, pos, mesg->avg_heart_rate);
    ImportInteger(115, libData, data, pos, mesg->max_heart_rate);
    ImportInteger(116, libData, data, pos, mesg->avg_cadence);
    ImportInteger(117, libData, data, pos, mesg->max_cadence);
    ImportInteger(118, libData, data, pos, mesg->total_training_effect);
    ImportInteger(119, libData, data, pos, mesg->event_group);
    ImportInteger(120, libData, data, pos, mesg->trigger);
    ImportInteger(121, libData, data, pos, mesg->swim_stroke);
    ImportInteger(122, libData, data, pos, mesg->pool_length_unit);
    ImportInteger(123, libData, data, pos, mesg->gps_accuracy);
    ImportInteger(124, libData, data, pos, mesg->avg_temperature);
    ImportInteger(125, libData, data, pos, mesg->max_temperature);
    ImportInteger(126, libData, data, pos, mesg->min_heart_rate);
    ImportInteger(127, libData, data, pos, mesg->avg_fractional_cadence);
    ImportInteger(128, libData, data, pos, mesg->max_fractional_cadence);
    ImportInteger(129, libData, data, pos, mesg->total_fractional_cycles);
    ImportInteger(130, libData, data, pos, mesg->avg_left_torque_effectiveness);
    ImportInteger(131, libData, data, pos, mesg->avg_right_torque_effectiveness);
    ImportInteger(132, libData, data, pos, mesg->avg_left_pedal_smoothness);
    ImportInteger(133, libData, data, pos, mesg->avg_right_pedal_smoothness);
    ImportInteger(134, libData, data, pos, mesg->avg_combined_pedal_smoothness);
    ImportInteger(135, libData, data, pos, mesg->sport_index);
    ImportInteger(136, libData, data, pos, mesg->avg_left_pco);
    ImportInteger(137, libData, data, pos, mesg->avg_right_pco);
    ImportIntegerSequence(138, libData, data, pos, mesg->avg_left_power_phase, FIT_SESSION_MESG_AVG_LEFT_POWER_PHASE_COUNT);
    ImportIntegerSequence(140, libData, data, pos, mesg->avg_left_power_phase_peak, FIT_SESSION_MESG_AVG_LEFT_POWER_PHASE_PEAK_COUNT);
    ImportIntegerSequence(142, libData, data, pos, mesg->avg_right_power_phase, FIT_SESSION_MESG_AVG_RIGHT_POWER_PHASE_COUNT);
    ImportIntegerSequence(144, libData, data, pos, mesg->avg_right_power_phase_peak, FIT_SESSION_MESG_AVG_RIGHT_POWER_PHASE_PEAK_COUNT);
    ImportIntegerSequence(146, libData, data, pos, mesg->avg_cadence_position, FIT_SESSION_MESG_AVG_CADENCE_POSITION_COUNT);
    ImportIntegerSequence(147, libData, data, pos, mesg->max_cadence_position, FIT_SESSION_MESG_MAX_CADENCE_POSITION_COUNT);
    ImportInteger(148, libData, data, pos, mesg->lev_battery_consumption);
    ImportInteger(149, libData, data, pos, mesg->total_anaerobic_training_effect);
    ImportInteger(150, libData, data, pos, mesg->total_fractional_ascent);
    ImportInteger(151, libData, data, pos, mesg->total_fractional_descent);
    ImportFinish(152, libData, data, pos);
}
...
static void import_workout(WolframLibraryData libData, MTensor data, int idx, const FIT_WORKOUT_MESG *mesg)
{
    ...
    ImportFinish(56, libData, data, pos);
}
