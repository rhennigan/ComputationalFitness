...
static void import_file_id(WolframLibraryData libData, MTensor data, int idx, const FIT_FILE_ID_MESG *mesg)
{
    ...
    ImportInteger(28, libData, data, pos, DONE);
}
...
static void import_file_creator(WolframLibraryData libData, MTensor data, int idx, const FIT_FILE_CREATOR_MESG *mesg)
{
    ...
    ImportInteger(4, libData, data, pos, DONE);
}
...
static void import_software(WolframLibraryData libData, MTensor data, int idx, const FIT_SOFTWARE_MESG *mesg)
{
    ...
    ImportInteger(20, libData, data, pos, DONE);
}
...
static void import_capabilities(WolframLibraryData libData, MTensor data, int idx, const FIT_CAPABILITIES_MESG *mesg)
{
    ...
    ImportInteger(9, libData, data, pos, DONE);
}
...
static void import_file_capabilities(WolframLibraryData libData, MTensor data, int idx, const FIT_FILE_CAPABILITIES_MESG *mesg)
{
    ...
    ImportInteger(23, libData, data, pos, DONE);
}
...
static void import_device_settings(WolframLibraryData libData, MTensor data, int idx, const FIT_DEVICE_SETTINGS_MESG *mesg)
{
    ...
    ImportInteger(22, libData, data, pos, DONE);
}
...
static void import_user_profile(WolframLibraryData libData, MTensor data, int idx, const FIT_USER_PROFILE_MESG *mesg)
{
    ...
    ImportInteger(18, libData, data, pos, mesg->message_index);
    ImportInteger(19, libData, data, pos, mesg->weight);
    ImportInteger(20, libData, data, pos, mesg->local_id);
    ImportInteger(21, libData, data, pos, mesg->user_running_step_length);
    ImportInteger(22, libData, data, pos, mesg->user_walking_step_length);
    ImportInteger(23, libData, data, pos, mesg->gender);
    ImportInteger(24, libData, data, pos, mesg->age);
    ImportInteger(25, libData, data, pos, mesg->height);
    ImportInteger(26, libData, data, pos, mesg->language);
    ImportInteger(27, libData, data, pos, mesg->elev_setting);
    ImportInteger(28, libData, data, pos, mesg->weight_setting);
    ImportInteger(29, libData, data, pos, mesg->resting_heart_rate);
    ImportInteger(30, libData, data, pos, mesg->default_max_running_heart_rate);
    ImportInteger(31, libData, data, pos, mesg->default_max_biking_heart_rate);
    ImportInteger(32, libData, data, pos, mesg->default_max_heart_rate);
    ImportInteger(33, libData, data, pos, mesg->hr_setting);
    ImportInteger(34, libData, data, pos, mesg->speed_setting);
    ImportInteger(35, libData, data, pos, mesg->dist_setting);
    ImportInteger(36, libData, data, pos, mesg->power_setting);
    ImportInteger(37, libData, data, pos, mesg->activity_class);
    ImportInteger(38, libData, data, pos, mesg->position_setting);
    ImportInteger(39, libData, data, pos, mesg->temperature_setting);
    ImportIntegerSequence(40, libData, data, pos, mesg->global_id, FIT_USER_PROFILE_MESG_GLOBAL_ID_COUNT);
    ImportInteger(46, libData, data, pos, mesg->height_setting);
    ImportInteger(47, libData, data, pos, DONE);
}
...
static void import_sdm_profile(WolframLibraryData libData, MTensor data, int idx, const FIT_SDM_PROFILE_MESG *mesg)
{
    ...
    ImportInteger(10, libData, data, pos, DONE);
}
...
static void import_bike_profile(WolframLibraryData libData, MTensor data, int idx, const FIT_BIKE_PROFILE_MESG *mesg)
{
    ...
    ImportInteger(49, libData, data, pos, DONE);
}
...
static void import_connectivity(WolframLibraryData libData, MTensor data, int idx, const FIT_CONNECTIVITY_MESG *mesg)
{
    ...
    ImportInteger(38, libData, data, pos, DONE);
}
...
static void import_met_zone(WolframLibraryData libData, MTensor data, int idx, const FIT_MET_ZONE_MESG *mesg)
{
    ...
    ImportInteger(6, libData, data, pos, DONE);
}
...
static void import_dive_settings(WolframLibraryData libData, MTensor data, int idx, const FIT_DIVE_SETTINGS_MESG *mesg)
{
    ...
    ImportInteger(19, libData, data, pos, DONE);
}
...
static void import_goal(WolframLibraryData libData, MTensor data, int idx, const FIT_GOAL_MESG *mesg)
{
    ...
    ImportInteger(15, libData, data, pos, DONE);
}
...
static void import_session(WolframLibraryData libData, MTensor data, int idx, const FIT_SESSION_MESG *mesg)
{
    ...
    ImportInteger(22, libData, data, pos, mesg->time_standing);
    ImportInteger(23, libData, data, pos, mesg->enhanced_avg_speed);
    ImportInteger(24, libData, data, pos, mesg->enhanced_max_speed);
    ImportInteger(25, libData, data, pos, mesg->enhanced_avg_altitude);
    ImportInteger(26, libData, data, pos, mesg->enhanced_min_altitude);
    ImportInteger(27, libData, data, pos, mesg->enhanced_max_altitude);
    ImportInteger(28, libData, data, pos, mesg->training_load_peak);
    ImportFloat(29, libData, data, pos, mesg->total_grit);
    ImportFloat(30, libData, data, pos, mesg->total_flow);
    ImportFloat(31, libData, data, pos, mesg->avg_grit);
    ImportFloat(32, libData, data, pos, mesg->avg_flow);
    ...
    ImportInteger(42, libData, data, pos, mesg->first_lap_index);
    ImportInteger(43, libData, data, pos, mesg->num_laps);
    ImportInteger(44, libData, data, pos, mesg->num_lengths);
    ImportInteger(45, libData, data, pos, mesg->normalized_power);
    ImportInteger(46, libData, data, pos, mesg->training_stress_score);
    ImportInteger(47, libData, data, pos, mesg->intensity_factor);
    ImportInteger(48, libData, data, pos, mesg->left_right_balance);
    ImportInteger(49, libData, data, pos, mesg->avg_stroke_distance);
    ImportInteger(50, libData, data, pos, mesg->pool_length);
    ImportInteger(51, libData, data, pos, mesg->threshold_power);
    ...
    ImportInteger(64, libData, data, pos, mesg->best_lap_index);
    ImportInteger(65, libData, data, pos, mesg->min_altitude);
    ImportInteger(66, libData, data, pos, mesg->player_score);
    ImportInteger(67, libData, data, pos, mesg->opponent_score);
    ImportIntegerSequence(68, libData, data, pos, mesg->stroke_count, FIT_SESSION_MESG_STROKE_COUNT_COUNT);
    ImportIntegerSequence(69, libData, data, pos, mesg->zone_count, FIT_SESSION_MESG_ZONE_COUNT_COUNT);
    ImportInteger(70, libData, data, pos, mesg->max_ball_speed);
    ImportInteger(71, libData, data, pos, mesg->avg_ball_speed);
    ImportInteger(72, libData, data, pos, mesg->avg_vertical_oscillation);
    ImportInteger(73, libData, data, pos, mesg->avg_stance_time_percent);
    ImportInteger(74, libData, data, pos, mesg->avg_stance_time);
    ImportIntegerSequence(75, libData, data, pos, mesg->avg_total_hemoglobin_conc, FIT_SESSION_MESG_AVG_TOTAL_HEMOGLOBIN_CONC_COUNT);
    ImportIntegerSequence(76, libData, data, pos, mesg->min_total_hemoglobin_conc, FIT_SESSION_MESG_MIN_TOTAL_HEMOGLOBIN_CONC_COUNT);
    ImportIntegerSequence(77, libData, data, pos, mesg->max_total_hemoglobin_conc, FIT_SESSION_MESG_MAX_TOTAL_HEMOGLOBIN_CONC_COUNT);
    ImportIntegerSequence(78, libData, data, pos, mesg->avg_saturated_hemoglobin_percent, FIT_SESSION_MESG_AVG_SATURATED_HEMOGLOBIN_PERCENT_COUNT);
    ImportIntegerSequence(79, libData, data, pos, mesg->min_saturated_hemoglobin_percent, FIT_SESSION_MESG_MIN_SATURATED_HEMOGLOBIN_PERCENT_COUNT);
    ImportIntegerSequence(80, libData, data, pos, mesg->max_saturated_hemoglobin_percent, FIT_SESSION_MESG_MAX_SATURATED_HEMOGLOBIN_PERCENT_COUNT);
    ImportInteger(81, libData, data, pos, mesg->stand_count);
    ImportIntegerSequence(82, libData, data, pos, mesg->avg_power_position, FIT_SESSION_MESG_AVG_POWER_POSITION_COUNT);
    ImportIntegerSequence(83, libData, data, pos, mesg->max_power_position, FIT_SESSION_MESG_MAX_POWER_POSITION_COUNT);
    ImportInteger(84, libData, data, pos, mesg->avg_lev_motor_power);
    ImportInteger(85, libData, data, pos, mesg->max_lev_motor_power);
    ImportInteger(86, libData, data, pos, mesg->avg_vertical_ratio);
    ImportInteger(87, libData, data, pos, mesg->avg_stance_time_balance);
    ImportInteger(88, libData, data, pos, mesg->avg_step_length);
    ImportInteger(89, libData, data, pos, mesg->avg_vam);
    ImportInteger(90, libData, data, pos, mesg->jump_count);
    ImportInteger(91, libData, data, pos, mesg->avg_core_temperature);
    ImportInteger(92, libData, data, pos, mesg->min_core_temperature);
    ImportInteger(93, libData, data, pos, mesg->max_core_temperature);
    ImportInteger(94, libData, data, pos, mesg->event);
    ImportInteger(95, libData, data, pos, mesg->event_type);
    ImportInteger(96, libData, data, pos, mesg->sport);
    ImportInteger(97, libData, data, pos, mesg->sub_sport);
    ...
    ImportInteger(102, libData, data, pos, mesg->total_training_effect);
    ImportInteger(103, libData, data, pos, mesg->event_group);
    ImportInteger(104, libData, data, pos, mesg->trigger);
    ImportInteger(105, libData, data, pos, mesg->swim_stroke);
    ImportInteger(106, libData, data, pos, mesg->pool_length_unit);
    ImportInteger(107, libData, data, pos, mesg->gps_accuracy);
    ImportInteger(108, libData, data, pos, mesg->avg_temperature);
    ImportInteger(109, libData, data, pos, mesg->max_temperature);
    ImportInteger(110, libData, data, pos, mesg->min_heart_rate);
    ImportString(111, libData, data, pos, mesg->opponent_name, FIT_SESSION_MESG_OPPONENT_NAME_COUNT);
    ImportInteger(112, libData, data, pos, mesg->avg_fractional_cadence);
    ImportInteger(113, libData, data, pos, mesg->max_fractional_cadence);
    ImportInteger(114, libData, data, pos, mesg->total_fractional_cycles);
    ImportInteger(115, libData, data, pos, mesg->avg_left_torque_effectiveness);
    ImportInteger(116, libData, data, pos, mesg->avg_right_torque_effectiveness);
    ImportInteger(117, libData, data, pos, mesg->avg_left_pedal_smoothness);
    ImportInteger(118, libData, data, pos, mesg->avg_right_pedal_smoothness);
    ImportInteger(119, libData, data, pos, mesg->avg_combined_pedal_smoothness);
    ImportInteger(120, libData, data, pos, mesg->sport_index);
    ImportInteger(121, libData, data, pos, mesg->avg_left_pco);
    ImportInteger(122, libData, data, pos, mesg->avg_right_pco);
    ImportIntegerSequence(123, libData, data, pos, mesg->avg_left_power_phase, FIT_SESSION_MESG_AVG_LEFT_POWER_PHASE_COUNT);
    ImportIntegerSequence(125, libData, data, pos, mesg->avg_left_power_phase_peak, FIT_SESSION_MESG_AVG_LEFT_POWER_PHASE_PEAK_COUNT);
    ImportIntegerSequence(127, libData, data, pos, mesg->avg_right_power_phase, FIT_SESSION_MESG_AVG_RIGHT_POWER_PHASE_COUNT);
    ImportIntegerSequence(129, libData, data, pos, mesg->avg_right_power_phase_peak, FIT_SESSION_MESG_AVG_RIGHT_POWER_PHASE_PEAK_COUNT);
    ImportIntegerSequence(131, libData, data, pos, mesg->avg_cadence_position, FIT_SESSION_MESG_AVG_CADENCE_POSITION_COUNT);
    ImportIntegerSequence(132, libData, data, pos, mesg->max_cadence_position, FIT_SESSION_MESG_MAX_CADENCE_POSITION_COUNT);
    ImportInteger(133, libData, data, pos, mesg->lev_battery_consumption);
    ImportInteger(134, libData, data, pos, mesg->total_anaerobic_training_effect);
    ImportInteger(135, libData, data, pos, mesg->total_fractional_ascent);
    ImportInteger(136, libData, data, pos, mesg->total_fractional_descent);
    ImportInteger(137, libData, data, pos, DONE);
}
...
static void import_lap(WolframLibraryData libData, MTensor data, int idx, const FIT_LAP_MESG *mesg)
{
    ...
    ImportInteger(85, libData, data, pos, DONE);
}
...
static void import_record(WolframLibraryData libData, MTensor data, int idx, const FIT_RECORD_MESG *mesg)
{
    ...
    ImportInteger(86, libData, data, pos, DONE);
}
...
static void import_event(WolframLibraryData libData, MTensor data, int idx, const FIT_EVENT_MESG *mesg)
{
    ...
    ImportInteger(16, libData, data, pos, DONE);
}
...
static void import_device_info(WolframLibraryData libData, MTensor data, int idx, const FIT_DEVICE_INFO_MESG *mesg)
{
    ...
    ImportInteger(39, libData, data, pos, DONE);
}
...
static void import_training_file(WolframLibraryData libData, MTensor data, int idx, const FIT_TRAINING_FILE_MESG *mesg)
{
    ...
    ImportInteger(8, libData, data, pos, DONE);
}
...
static void import_weather_conditions(WolframLibraryData libData, MTensor data, int idx, const FIT_WEATHER_CONDITIONS_MESG *mesg)
{
    ...
    ImportInteger(81, libData, data, pos, DONE);
}
...
static void import_nmea_sentence(WolframLibraryData libData, MTensor data, int idx, const FIT_NMEA_SENTENCE_MESG *mesg)
{
    ...
    ImportInteger(87, libData, data, pos, DONE);
}
...
static void import_aviation_attitude(WolframLibraryData libData, MTensor data, int idx, const FIT_AVIATION_ATTITUDE_MESG *mesg)
{
    ...
    ImportInteger(14, libData, data, pos, DONE);
}
...
static void import_video_title(WolframLibraryData libData, MTensor data, int idx, const FIT_VIDEO_TITLE_MESG *mesg)
{
    ...
    ImportInteger(84, libData, data, pos, DONE);
}
...
static void import_video_description(WolframLibraryData libData, MTensor data, int idx, const FIT_VIDEO_DESCRIPTION_MESG *mesg)
{
    ...
    ImportInteger(2, libData, data, pos, mesg->message_index);
    ImportInteger(3, libData, data, pos, mesg->message_count);
    ImportString(4, libData, data, pos, mesg->text, FIT_VIDEO_DESCRIPTION_MESG_TEXT_COUNT);
    ImportInteger(254, libData, data, pos, DONE);
}
...
static void import_set(WolframLibraryData libData, MTensor data, int idx, const FIT_SET_MESG *mesg)
{
    ...
    ImportInteger(3, libData, data, pos, DONE);
}
...
static void import_field_description(WolframLibraryData libData, MTensor data, int idx, const FIT_FIELD_DESCRIPTION_MESG *mesg)
{
    ...
    ImportInteger(90, libData, data, pos, DONE);
}
...
static void import_developer_data_id(WolframLibraryData libData, MTensor data, int idx, const FIT_DEVELOPER_DATA_ID_MESG *mesg)
{
    ...
    ImportInteger(37, libData, data, pos, DONE);
}
...
static void import_course(WolframLibraryData libData, MTensor data, int idx, const FIT_COURSE_MESG *mesg)
{
    ...
    ImportInteger(21, libData, data, pos, DONE);
}
...
static void import_course_point(WolframLibraryData libData, MTensor data, int idx, const FIT_COURSE_POINT_MESG *mesg)
{
    ...
    ImportInteger(25, libData, data, pos, DONE);
}
...
static void import_segment_id(WolframLibraryData libData, MTensor data, int idx, const FIT_SEGMENT_ID_MESG *mesg)
{
    ...
    ImportInteger(11, libData, data, pos, DONE);
}
...
static void import_segment_lap(WolframLibraryData libData, MTensor data, int idx, const FIT_SEGMENT_LAP_MESG *mesg)
{
    ...
    ImportInteger(122, libData, data, pos, DONE);
}
...
static void import_workout(WolframLibraryData libData, MTensor data, int idx, const FIT_WORKOUT_MESG *mesg)
{
    ...
    ImportInteger(51, libData, data, pos, mesg->num_valid_steps);
    ImportInteger(52, libData, data, pos, mesg->pool_length);
    ImportInteger(53, libData, data, pos, mesg->sport);
    ImportInteger(54, libData, data, pos, mesg->sub_sport);
    ImportInteger(55, libData, data, pos, mesg->pool_length_unit);
    ImportInteger(56, libData, data, pos, DONE);
}
...
static void import_workout_step(WolframLibraryData libData, MTensor data, int idx, const FIT_WORKOUT_STEP_MESG *mesg)
{
    ...
    ImportInteger(114, libData, data, pos, DONE);
}
...
static void import_exercise_title(WolframLibraryData libData, MTensor data, int idx, const FIT_EXERCISE_TITLE_MESG *mesg)
{
    ...
    ImportInteger(202, libData, data, pos, mesg->message_index);
    ImportInteger(203, libData, data, pos, mesg->exercise_category);
    ImportInteger(204, libData, data, pos, mesg->exercise_name);
    ImportInteger(205, libData, data, pos, DONE);
}
...
static void import_blood_pressure(WolframLibraryData libData, MTensor data, int idx, const FIT_BLOOD_PRESSURE_MESG *mesg)
{
    ...
    ImportInteger(13, libData, data, pos, DONE);
}
