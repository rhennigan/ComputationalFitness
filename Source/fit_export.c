...
static void export_bike_profile(WolframLibraryData libData, MTensor data, int idx, FILE *fp) {
    ...
    ExportInteger(18, libData, data, pos, mesg.odometer);
    ExportInteger(19, libData, data, pos, mesg.message_index);
    ExportInteger(20, libData, data, pos, mesg.bike_spd_ant_id);
    ExportInteger(21, libData, data, pos, mesg.bike_cad_ant_id);
    ExportInteger(22, libData, data, pos, mesg.bike_spdcad_ant_id);
    ExportInteger(23, libData, data, pos, mesg.bike_power_ant_id);
    ExportInteger(24, libData, data, pos, mesg.custom_wheelsize);
    ExportInteger(25, libData, data, pos, mesg.auto_wheelsize);
    ExportInteger(26, libData, data, pos, mesg.bike_weight);
    ExportInteger(27, libData, data, pos, mesg.power_cal_factor);
    ExportInteger(28, libData, data, pos, mesg.sport);
    ExportInteger(29, libData, data, pos, mesg.sub_sport);
    ExportInteger(30, libData, data, pos, mesg.auto_wheel_cal);
    ExportInteger(31, libData, data, pos, mesg.auto_power_zero);
    ExportInteger(32, libData, data, pos, mesg.id);
    ExportInteger(33, libData, data, pos, mesg.spd_enabled);
    ExportInteger(34, libData, data, pos, mesg.cad_enabled);
    ExportInteger(35, libData, data, pos, mesg.spdcad_enabled);
    ExportInteger(36, libData, data, pos, mesg.power_enabled);
    ExportInteger(37, libData, data, pos, mesg.crank_length);
    ExportInteger(38, libData, data, pos, mesg.enabled);
    ExportInteger(39, libData, data, pos, mesg.bike_spd_ant_id_trans_type);
    ExportInteger(40, libData, data, pos, mesg.bike_cad_ant_id_trans_type);
    ExportInteger(41, libData, data, pos, mesg.bike_spdcad_ant_id_trans_type);
    ExportInteger(42, libData, data, pos, mesg.bike_power_ant_id_trans_type);
    ExportInteger(43, libData, data, pos, mesg.odometer_rollover);
    ExportInteger(44, libData, data, pos, mesg.front_gear_num);
    ExportIntegerSequence(45, libData, data, pos, mesg.front_gear, FIT_BIKE_PROFILE_MESG_FRONT_GEAR_COUNT);
    ExportInteger(46, libData, data, pos, mesg.rear_gear_num);
    ExportIntegerSequence(47, libData, data, pos, mesg.rear_gear, FIT_BIKE_PROFILE_MESG_REAR_GEAR_COUNT);
    ExportInteger(48, libData, data, pos, mesg.shimano_di2_enabled);
...
static void export_session(WolframLibraryData libData, MTensor data, int idx, FILE *fp) {
    ...
    ExportIntegerSequence(18, libData, data, pos, mesg.time_in_speed_zone, FIT_SESSION_MESG_TIME_IN_SPEED_ZONE_COUNT);
    ExportIntegerSequence(19, libData, data, pos, mesg.time_in_cadence_zone, FIT_SESSION_MESG_TIME_IN_CADENCE_ZONE_COUNT);
    ExportIntegerSequence(20, libData, data, pos, mesg.time_in_power_zone, FIT_SESSION_MESG_TIME_IN_POWER_ZONE_COUNT);
    ExportInteger(21, libData, data, pos, mesg.avg_lap_time);
    ExportString(22, libData, data, pos, mesg.opponent_name, FIT_SESSION_MESG_OPPONENT_NAME_COUNT);
    ExportInteger(38, libData, data, pos, mesg.time_standing);
    ExportIntegerSequence(39, libData, data, pos, mesg.avg_power_position, FIT_SESSION_MESG_AVG_POWER_POSITION_COUNT);
    ExportIntegerSequence(41, libData, data, pos, mesg.max_power_position, FIT_SESSION_MESG_MAX_POWER_POSITION_COUNT);
    ExportInteger(43, libData, data, pos, mesg.enhanced_avg_speed);
    ExportInteger(44, libData, data, pos, mesg.enhanced_max_speed);
    ExportInteger(45, libData, data, pos, mesg.enhanced_avg_altitude);
    ExportInteger(46, libData, data, pos, mesg.enhanced_min_altitude);
    ExportInteger(47, libData, data, pos, mesg.enhanced_max_altitude);
    ExportInteger(48, libData, data, pos, mesg.training_load_peak);
    ExportFloat32(49, libData, data, pos, mesg.total_grit);
    ExportFloat32(50, libData, data, pos, mesg.total_flow);
    ExportFloat32(51, libData, data, pos, mesg.avg_grit);
    ExportFloat32(52, libData, data, pos, mesg.avg_flow);
    ExportInteger(53, libData, data, pos, mesg.message_index);
    ExportInteger(54, libData, data, pos, mesg.total_calories);
    ExportInteger(55, libData, data, pos, mesg.total_fat_calories);
    ExportInteger(56, libData, data, pos, mesg.avg_speed);
    ExportInteger(57, libData, data, pos, mesg.max_speed);
    ExportInteger(58, libData, data, pos, mesg.avg_power);
    ExportInteger(59, libData, data, pos, mesg.max_power);
    ExportInteger(60, libData, data, pos, mesg.total_ascent);
    ExportInteger(61, libData, data, pos, mesg.total_descent);
    ExportInteger(62, libData, data, pos, mesg.first_lap_index);
    ExportInteger(63, libData, data, pos, mesg.num_laps);
    ExportInteger(64, libData, data, pos, mesg.num_lengths);
    ExportInteger(65, libData, data, pos, mesg.normalized_power);
    ExportInteger(66, libData, data, pos, mesg.training_stress_score);
    ExportInteger(67, libData, data, pos, mesg.intensity_factor);
    ExportInteger(68, libData, data, pos, mesg.left_right_balance);
    ExportInteger(69, libData, data, pos, mesg.avg_stroke_distance);
    ExportInteger(70, libData, data, pos, mesg.pool_length);
    ExportInteger(71, libData, data, pos, mesg.threshold_power);
    ExportInteger(72, libData, data, pos, mesg.num_active_lengths);
    ExportInteger(73, libData, data, pos, mesg.avg_altitude);
    ExportInteger(74, libData, data, pos, mesg.max_altitude);
    ExportInteger(75, libData, data, pos, mesg.avg_grade);
    ExportInteger(76, libData, data, pos, mesg.avg_pos_grade);
    ExportInteger(77, libData, data, pos, mesg.avg_neg_grade);
    ExportInteger(78, libData, data, pos, mesg.max_pos_grade);
    ExportInteger(79, libData, data, pos, mesg.max_neg_grade);
    ExportInteger(80, libData, data, pos, mesg.avg_pos_vertical_speed);
    ExportInteger(81, libData, data, pos, mesg.avg_neg_vertical_speed);
    ExportInteger(82, libData, data, pos, mesg.max_pos_vertical_speed);
    ExportInteger(83, libData, data, pos, mesg.max_neg_vertical_speed);
    ExportInteger(84, libData, data, pos, mesg.best_lap_index);
    ExportInteger(85, libData, data, pos, mesg.min_altitude);
    ExportInteger(86, libData, data, pos, mesg.player_score);
    ExportInteger(87, libData, data, pos, mesg.opponent_score);
    ExportIntegerSequence(88, libData, data, pos, mesg.stroke_count, FIT_SESSION_MESG_STROKE_COUNT_COUNT);
    ExportIntegerSequence(89, libData, data, pos, mesg.zone_count, FIT_SESSION_MESG_ZONE_COUNT_COUNT);
    ExportInteger(90, libData, data, pos, mesg.max_ball_speed);
    ExportInteger(91, libData, data, pos, mesg.avg_ball_speed);
    ExportInteger(92, libData, data, pos, mesg.avg_vertical_oscillation);
    ExportInteger(93, libData, data, pos, mesg.avg_stance_time_percent);
    ExportInteger(94, libData, data, pos, mesg.avg_stance_time);
    ExportIntegerSequence(95, libData, data, pos, mesg.avg_total_hemoglobin_conc, FIT_SESSION_MESG_AVG_TOTAL_HEMOGLOBIN_CONC_COUNT);
    ExportIntegerSequence(96, libData, data, pos, mesg.min_total_hemoglobin_conc, FIT_SESSION_MESG_MIN_TOTAL_HEMOGLOBIN_CONC_COUNT);
    ExportIntegerSequence(97, libData, data, pos, mesg.max_total_hemoglobin_conc, FIT_SESSION_MESG_MAX_TOTAL_HEMOGLOBIN_CONC_COUNT);
    ExportIntegerSequence(98, libData, data, pos, mesg.avg_saturated_hemoglobin_percent, FIT_SESSION_MESG_AVG_SATURATED_HEMOGLOBIN_PERCENT_COUNT);
    ExportIntegerSequence(99, libData, data, pos, mesg.min_saturated_hemoglobin_percent, FIT_SESSION_MESG_MIN_SATURATED_HEMOGLOBIN_PERCENT_COUNT);
    ExportIntegerSequence(100, libData, data, pos, mesg.max_saturated_hemoglobin_percent, FIT_SESSION_MESG_MAX_SATURATED_HEMOGLOBIN_PERCENT_COUNT);
    ExportInteger(101, libData, data, pos, mesg.stand_count);
    ExportInteger(102, libData, data, pos, mesg.avg_lev_motor_power);
    ExportInteger(103, libData, data, pos, mesg.max_lev_motor_power);
    ExportInteger(104, libData, data, pos, mesg.avg_vertical_ratio);
    ExportInteger(105, libData, data, pos, mesg.avg_stance_time_balance);
    ExportInteger(106, libData, data, pos, mesg.avg_step_length);
    ExportInteger(107, libData, data, pos, mesg.avg_vam);
    ExportInteger(108, libData, data, pos, mesg.jump_count);
    ExportInteger(109, libData, data, pos, mesg.avg_core_temperature);
    ExportInteger(110, libData, data, pos, mesg.min_core_temperature);
    ExportInteger(111, libData, data, pos, mesg.max_core_temperature);
    ExportInteger(112, libData, data, pos, mesg.event);
    ExportInteger(113, libData, data, pos, mesg.event_type);
    ExportInteger(114, libData, data, pos, mesg.sport);
    ExportInteger(115, libData, data, pos, mesg.sub_sport);
    ExportInteger(116, libData, data, pos, mesg.avg_heart_rate);
    ExportInteger(117, libData, data, pos, mesg.max_heart_rate);
    ExportInteger(118, libData, data, pos, mesg.avg_cadence);
    ExportInteger(119, libData, data, pos, mesg.max_cadence);
    ExportInteger(120, libData, data, pos, mesg.total_training_effect);
    ExportInteger(121, libData, data, pos, mesg.event_group);
    ExportInteger(122, libData, data, pos, mesg.trigger);
    ExportInteger(123, libData, data, pos, mesg.swim_stroke);
    ExportInteger(124, libData, data, pos, mesg.pool_length_unit);
    ExportInteger(125, libData, data, pos, mesg.gps_accuracy);
    ExportInteger(126, libData, data, pos, mesg.avg_temperature);
    ExportInteger(127, libData, data, pos, mesg.max_temperature);
    ExportInteger(128, libData, data, pos, mesg.min_heart_rate);
    ...
    ExportInteger(132, libData, data, pos, mesg.avg_left_torque_effectiveness);
    ExportInteger(133, libData, data, pos, mesg.avg_right_torque_effectiveness);
    ExportInteger(134, libData, data, pos, mesg.avg_left_pedal_smoothness);
    ExportInteger(135, libData, data, pos, mesg.avg_right_pedal_smoothness);
    ExportInteger(136, libData, data, pos, mesg.avg_combined_pedal_smoothness);
    ExportInteger(137, libData, data, pos, mesg.sport_index);
    ExportInteger(138, libData, data, pos, mesg.avg_left_pco);
    ExportInteger(139, libData, data, pos, mesg.avg_right_pco);
    ExportIntegerSequence(140, libData, data, pos, mesg.avg_left_power_phase, FIT_SESSION_MESG_AVG_LEFT_POWER_PHASE_COUNT);
    ExportIntegerSequence(142, libData, data, pos, mesg.avg_left_power_phase_peak, FIT_SESSION_MESG_AVG_LEFT_POWER_PHASE_PEAK_COUNT);
    ExportIntegerSequence(144, libData, data, pos, mesg.avg_right_power_phase, FIT_SESSION_MESG_AVG_RIGHT_POWER_PHASE_COUNT);
    ExportIntegerSequence(146, libData, data, pos, mesg.avg_right_power_phase_peak, FIT_SESSION_MESG_AVG_RIGHT_POWER_PHASE_PEAK_COUNT);
    ExportIntegerSequence(148, libData, data, pos, mesg.avg_cadence_position, FIT_SESSION_MESG_AVG_CADENCE_POSITION_COUNT);
    ExportIntegerSequence(150, libData, data, pos, mesg.max_cadence_position, FIT_SESSION_MESG_MAX_CADENCE_POSITION_COUNT);
    ExportInteger(152, libData, data, pos, mesg.lev_battery_consumption);
    ExportInteger(153, libData, data, pos, mesg.total_anaerobic_training_effect);
    ExportInteger(154, libData, data, pos, mesg.total_fractional_ascent);
    ExportInteger(155, libData, data, pos, mesg.total_fractional_descent);
...
static void export_lap(WolframLibraryData libData, MTensor data, int idx, FILE *fp) {
    ...
    ExportIntegerSequence(15, libData, data, pos, mesg.time_in_speed_zone, FIT_LAP_MESG_TIME_IN_SPEED_ZONE_COUNT);
    ExportIntegerSequence(16, libData, data, pos, mesg.time_in_cadence_zone, FIT_LAP_MESG_TIME_IN_CADENCE_ZONE_COUNT);
    ExportIntegerSequence(17, libData, data, pos, mesg.time_in_power_zone, FIT_LAP_MESG_TIME_IN_POWER_ZONE_COUNT);
    ExportInteger(18, libData, data, pos, mesg.enhanced_avg_speed);
    ExportInteger(19, libData, data, pos, mesg.enhanced_max_speed);
    ExportInteger(20, libData, data, pos, mesg.enhanced_avg_altitude);
    ExportInteger(21, libData, data, pos, mesg.enhanced_min_altitude);
    ExportInteger(22, libData, data, pos, mesg.enhanced_max_altitude);
    ExportInteger(23, libData, data, pos, mesg.message_index);
    ExportInteger(24, libData, data, pos, mesg.total_calories);
    ExportInteger(25, libData, data, pos, mesg.total_fat_calories);
    ExportInteger(26, libData, data, pos, mesg.avg_speed);
    ExportInteger(27, libData, data, pos, mesg.max_speed);
    ExportInteger(28, libData, data, pos, mesg.avg_power);
    ExportInteger(29, libData, data, pos, mesg.max_power);
    ExportInteger(30, libData, data, pos, mesg.total_ascent);
    ExportInteger(31, libData, data, pos, mesg.total_descent);
    ExportInteger(32, libData, data, pos, mesg.num_lengths);
    ExportInteger(33, libData, data, pos, mesg.normalized_power);
    ExportInteger(34, libData, data, pos, mesg.left_right_balance);
    ExportInteger(35, libData, data, pos, mesg.first_length_index);
    ExportInteger(36, libData, data, pos, mesg.avg_stroke_distance);
    ExportInteger(37, libData, data, pos, mesg.num_active_lengths);
    ExportInteger(38, libData, data, pos, mesg.avg_altitude);
    ExportInteger(39, libData, data, pos, mesg.max_altitude);
    ExportInteger(40, libData, data, pos, mesg.avg_grade);
    ExportInteger(41, libData, data, pos, mesg.avg_pos_grade);
    ExportInteger(42, libData, data, pos, mesg.avg_neg_grade);
    ExportInteger(43, libData, data, pos, mesg.max_pos_grade);
    ExportInteger(44, libData, data, pos, mesg.max_neg_grade);
    ExportInteger(45, libData, data, pos, mesg.avg_pos_vertical_speed);
    ExportInteger(46, libData, data, pos, mesg.avg_neg_vertical_speed);
    ExportInteger(47, libData, data, pos, mesg.max_pos_vertical_speed);
    ExportInteger(48, libData, data, pos, mesg.max_neg_vertical_speed);
    ExportInteger(49, libData, data, pos, mesg.repetition_num);
    ExportInteger(50, libData, data, pos, mesg.min_altitude);
    ExportInteger(51, libData, data, pos, mesg.wkt_step_index);
    ExportInteger(52, libData, data, pos, mesg.opponent_score);
    ExportIntegerSequence(53, libData, data, pos, mesg.stroke_count, FIT_LAP_MESG_STROKE_COUNT_COUNT);
    ExportIntegerSequence(54, libData, data, pos, mesg.zone_count, FIT_LAP_MESG_ZONE_COUNT_COUNT);
    ExportInteger(55, libData, data, pos, mesg.avg_vertical_oscillation);
    ExportInteger(56, libData, data, pos, mesg.avg_stance_time_percent);
    ExportInteger(57, libData, data, pos, mesg.avg_stance_time);
    ExportInteger(58, libData, data, pos, mesg.player_score);
    ExportIntegerSequence(59, libData, data, pos, mesg.avg_total_hemoglobin_conc, FIT_LAP_MESG_AVG_TOTAL_HEMOGLOBIN_CONC_COUNT);
    ExportIntegerSequence(60, libData, data, pos, mesg.min_total_hemoglobin_conc, FIT_LAP_MESG_MIN_TOTAL_HEMOGLOBIN_CONC_COUNT);
    ExportIntegerSequence(61, libData, data, pos, mesg.max_total_hemoglobin_conc, FIT_LAP_MESG_MAX_TOTAL_HEMOGLOBIN_CONC_COUNT);
    ExportIntegerSequence(62, libData, data, pos, mesg.avg_saturated_hemoglobin_percent, FIT_LAP_MESG_AVG_SATURATED_HEMOGLOBIN_PERCENT_COUNT);
    ExportIntegerSequence(63, libData, data, pos, mesg.min_saturated_hemoglobin_percent, FIT_LAP_MESG_MIN_SATURATED_HEMOGLOBIN_PERCENT_COUNT);
    ExportIntegerSequence(64, libData, data, pos, mesg.max_saturated_hemoglobin_percent, FIT_LAP_MESG_MAX_SATURATED_HEMOGLOBIN_PERCENT_COUNT);
    ExportInteger(65, libData, data, pos, mesg.avg_vam);
    ExportInteger(66, libData, data, pos, mesg.event);
    ExportInteger(67, libData, data, pos, mesg.event_type);
    ExportInteger(68, libData, data, pos, mesg.avg_heart_rate);
    ExportInteger(69, libData, data, pos, mesg.max_heart_rate);
    ExportInteger(70, libData, data, pos, mesg.avg_cadence);
    ExportInteger(71, libData, data, pos, mesg.max_cadence);
    ExportInteger(72, libData, data, pos, mesg.intensity);
    ExportInteger(73, libData, data, pos, mesg.lap_trigger);
    ExportInteger(74, libData, data, pos, mesg.sport);
    ExportInteger(75, libData, data, pos, mesg.event_group);
    ExportInteger(76, libData, data, pos, mesg.swim_stroke);
    ExportInteger(77, libData, data, pos, mesg.sub_sport);
    ExportInteger(78, libData, data, pos, mesg.gps_accuracy);
    ExportInteger(79, libData, data, pos, mesg.avg_temperature);
    ExportInteger(80, libData, data, pos, mesg.max_temperature);
    ExportInteger(81, libData, data, pos, mesg.min_heart_rate);
    ExportInteger(82, libData, data, pos, mesg.avg_fractional_cadence);
    ExportInteger(83, libData, data, pos, mesg.max_fractional_cadence);
    ExportInteger(84, libData, data, pos, mesg.total_fractional_cycles);
...
static void export_length(WolframLibraryData libData, MTensor data, int idx, FILE *fp) {
    ...
    ExportInteger(14, libData, data, pos, mesg.event);
    ExportInteger(15, libData, data, pos, mesg.event_type);
    ExportInteger(16, libData, data, pos, mesg.swim_stroke);
    ExportInteger(17, libData, data, pos, mesg.avg_swimming_cadence);
    ExportInteger(18, libData, data, pos, mesg.event_group);
    ExportInteger(19, libData, data, pos, mesg.length_type);
...
static void export_device_info(WolframLibraryData libData, MTensor data, int idx, FILE *fp) {
    ...
    ExportString(5, libData, data, pos, mesg.product_name, FIT_DEVICE_INFO_MESG_PRODUCT_NAME_COUNT);
    ExportInteger(25, libData, data, pos, mesg.manufacturer);
    ExportInteger(26, libData, data, pos, mesg.product);
    ExportInteger(27, libData, data, pos, mesg.software_version);
    ExportInteger(28, libData, data, pos, mesg.battery_voltage);
    ExportInteger(29, libData, data, pos, mesg.ant_device_number);
    ExportInteger(30, libData, data, pos, mesg.device_index);
    ExportInteger(31, libData, data, pos, mesg.device_type);
    ExportInteger(32, libData, data, pos, mesg.hardware_version);
    ExportInteger(33, libData, data, pos, mesg.battery_status);
    ExportInteger(34, libData, data, pos, mesg.sensor_position);
    ExportString(35, libData, data, pos, mesg.descriptor, FIT_DEVICE_INFO_MESG_DESCRIPTOR_COUNT);
    ExportInteger(36, libData, data, pos, mesg.ant_transmission_type);
    ExportInteger(37, libData, data, pos, mesg.ant_network);
    ExportInteger(38, libData, data, pos, mesg.source_type);
    ExportInteger(39, libData, data, pos, mesg.battery_level);
...
static void export_segment_id(WolframLibraryData libData, MTensor data, int idx, FILE *fp) {
    ...
    ExportInteger(3, libData, data, pos, mesg.device_id);
    ExportString(4, libData, data, pos, mesg.name, FIT_SEGMENT_ID_MESG_NAME_COUNT);
    ExportString(5, libData, data, pos, mesg.uuid, FIT_SEGMENT_ID_MESG_UUID_COUNT);
    ExportInteger(6, libData, data, pos, mesg.sport);
    ExportInteger(7, libData, data, pos, mesg.enabled);
    ExportInteger(8, libData, data, pos, mesg.default_race_leader);
    ExportInteger(9, libData, data, pos, mesg.delete_status);
    ExportInteger(10, libData, data, pos, mesg.selection_type);
...
static void export_segment_lap(WolframLibraryData libData, MTensor data, int idx, FILE *fp) {
    ...
    ExportIntegerSequence(35, libData, data, pos, mesg.time_in_speed_zone, FIT_SEGMENT_LAP_MESG_TIME_IN_SPEED_ZONE_COUNT);
    ExportIntegerSequence(36, libData, data, pos, mesg.time_in_cadence_zone, FIT_SEGMENT_LAP_MESG_TIME_IN_CADENCE_ZONE_COUNT);
    ExportIntegerSequence(37, libData, data, pos, mesg.time_in_power_zone, FIT_SEGMENT_LAP_MESG_TIME_IN_POWER_ZONE_COUNT);
    ExportInteger(38, libData, data, pos, mesg.active_time);
    ...
    ExportInteger(50, libData, data, pos, mesg.avg_altitude);
    ExportInteger(51, libData, data, pos, mesg.max_altitude);
    ExportInteger(52, libData, data, pos, mesg.avg_grade);
    ExportInteger(53, libData, data, pos, mesg.avg_pos_grade);
    ExportInteger(54, libData, data, pos, mesg.avg_neg_grade);
    ExportInteger(55, libData, data, pos, mesg.max_pos_grade);
    ExportInteger(56, libData, data, pos, mesg.max_neg_grade);
    ExportInteger(57, libData, data, pos, mesg.avg_pos_vertical_speed);
    ExportInteger(58, libData, data, pos, mesg.avg_neg_vertical_speed);
    ExportInteger(59, libData, data, pos, mesg.max_pos_vertical_speed);
    ExportInteger(60, libData, data, pos, mesg.max_neg_vertical_speed);
    ExportInteger(61, libData, data, pos, mesg.repetition_num);
    ExportInteger(62, libData, data, pos, mesg.min_altitude);
    ExportInteger(63, libData, data, pos, mesg.wkt_step_index);
    ExportInteger(64, libData, data, pos, mesg.front_gear_shift_count);
    ExportInteger(65, libData, data, pos, mesg.rear_gear_shift_count);
    ExportInteger(66, libData, data, pos, mesg.event);
    ExportInteger(67, libData, data, pos, mesg.event_type);
    ExportInteger(68, libData, data, pos, mesg.avg_heart_rate);
    ExportInteger(69, libData, data, pos, mesg.max_heart_rate);
    ExportInteger(70, libData, data, pos, mesg.avg_cadence);
    ExportInteger(71, libData, data, pos, mesg.max_cadence);
    ExportInteger(72, libData, data, pos, mesg.sport);
    ExportInteger(73, libData, data, pos, mesg.event_group);
    ExportInteger(74, libData, data, pos, mesg.sub_sport);
    ExportInteger(75, libData, data, pos, mesg.gps_accuracy);
    ExportInteger(76, libData, data, pos, mesg.avg_temperature);
    ExportInteger(77, libData, data, pos, mesg.max_temperature);
    ExportInteger(78, libData, data, pos, mesg.min_heart_rate);
    ExportInteger(79, libData, data, pos, mesg.sport_event);
    ExportInteger(80, libData, data, pos, mesg.avg_left_torque_effectiveness);
    ExportInteger(81, libData, data, pos, mesg.avg_right_torque_effectiveness);
    ExportInteger(82, libData, data, pos, mesg.avg_left_pedal_smoothness);
    ExportInteger(83, libData, data, pos, mesg.avg_right_pedal_smoothness);
    ExportInteger(84, libData, data, pos, mesg.avg_combined_pedal_smoothness);
    ExportInteger(85, libData, data, pos, mesg.status);
    ExportString(86, libData, data, pos, mesg.uuid, FIT_SEGMENT_LAP_MESG_UUID_COUNT);
    ExportInteger(119, libData, data, pos, mesg.avg_fractional_cadence);
    ExportInteger(120, libData, data, pos, mesg.max_fractional_cadence);
    ExportInteger(121, libData, data, pos, mesg.total_fractional_cycles);
